...
<Warning>
JSON mode is available on paid plans only. Add a token from [dash.llm7.io](https://dash.llm7.io) before you start.
</Warning>
...
client = openai.OpenAI(
    ...
    api_key="unused",  # Required. Get it for free at https://dash.llm7.io/ for higher rate limits.
)
