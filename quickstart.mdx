...
<Tip><code>model="default"</code> is a smart router. Pin a specific model later if needed.</Tip> </Accordion> </AccordionGroup>
...
<Tip>Responses return a CDN URL you can open in the browser or embed directly.</Tip> </Accordion> </AccordionGroup>
